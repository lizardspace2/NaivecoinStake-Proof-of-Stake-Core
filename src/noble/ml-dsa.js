...
const { mod, smod, NTT, bitsCoder } = (0, _crystals_1.genCrystals)({
    N,
    Q,
    F,
    ROOT_OF_UNITY,
...
function getDilithium(opts) {
    ...
    const W1Vec = (0, utils_1.vecCoder)(W1Coder, K);
    // Main structures
    const publicCoder = (0, utils_1.splitCoder)('publicKey', 32, (0, utils_1.vecCoder)(T1Coder, K));
    const secretCoder = (0, utils_1.splitCoder)('secretKey', 32, 32, TR_BYTES, (0, utils_1.vecCoder)(ETACoder, L), (0, utils_1.vecCoder)(ETACoder, K), (0, utils_1.vecCoder)(T0Coder, K));
    const sigCoder = (0, utils_1.splitCoder)('signature', C_TILDE_BYTES, (0, utils_1.vecCoder)(ZCoder, L), hintCoder);
    ...
    const seedCoder = (0, utils_1.splitCoder)('seed', 32, 64, 32);
    ...
    const internal = {
        ...
        keygen: (seed) => {
            ...
            if (randSeed)
                seed = (0, utils_1.randomBytes)(32);
            (0, utils_1.abytes)(seed, 32, 'seed');
            seedDst.set(seed);
            if (randSeed)
            ...
            for (let i = 0; i < K; i++) {
                // t ← NTT−1(A*NTT(s1)) + s2
                (0, utils_1.cleanBytes)(t); // don't-reallocate
                for (let j = 0; j < L; j++) {
            ...
            (0, utils_1.cleanBytes)(rho, rhoPrime, K_, s1, s2, s1Hat, t, t0, t1, tr, seedDst);
        ...
        getPublicKey: (secretKey) => {
            ...
            xof.clean();
            (0, utils_1.cleanBytes)(tmp, s1Hat, _t0, s1, s2);
            return publicCoder.encode([rho, t1]);
        },
        // NOTE: random is optional.
        sign: (msg, secretKey, opts = {}) => {
            (0, utils_1.validateSigOpts)(opts);
            ...
            main_loop: for (let kappa = 0;;) {
                ...
                (0, utils_1.cleanBytes)(cTilde, cs1, h, cHat, w1, w, z, y, rhoprime, mu, s1, s2, t0, ...A);
                return res;
            }
            // @ts-ignore
        ...
        verify: (sig, msg, publicKey, opts = {}) => {
            ...
            for (const t of z)
                if (polyChknorm(t, GAMMA1 - BETA))
                    return false;
            return (0, utils_1.equalBytes)(cTilde, c2);
        },
    };
    return {
        info: { type: 'ml-dsa' },
        ...
        sign: (msg, secretKey, opts = {}) => {
            (0, utils_1.validateSigOpts)(opts);
            const M = (0, utils_1.getMessage)(msg, opts.context);
            const res = internal.sign(M, secretKey, opts);
            (0, utils_1.cleanBytes)(M);
            return res;
        },
        verify: (sig, msg, publicKey, opts = {}) => {
            (0, utils_1.validateVerOpts)(opts);
            return internal.verify(sig, (0, utils_1.getMessage)(msg, opts.context), publicKey);
        },
        prehash: (hash) => {
            (0, utils_1.checkHash)(hash, securityLevel);
            return {
                ...
                sign: (msg, secretKey, opts = {}) => {
                    (0, utils_1.validateSigOpts)(opts);
                    const M = (0, utils_1.getMessagePrehash)(hash, msg, opts.context);
                    const res = internal.sign(M, secretKey, opts);
                    (0, utils_1.cleanBytes)(M);
                    return res;
                },
                verify: (sig, msg, publicKey, opts = {}) => {
                    (0, utils_1.validateVerOpts)(opts);
                    return internal.verify(sig, (0, utils_1.getMessagePrehash)(hash, msg, opts.context), publicKey);
                },
            };
        },
    };
...
exports.ml_dsa44 = getDilithium({
    ...
    TR_BYTES: 64,
    C_TILDE_BYTES: 32,
    XOF128: _crystals_1.XOF128,
    XOF256: _crystals_1.XOF256,
    securityLevel: 128,
});
